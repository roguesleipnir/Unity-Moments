...
namespace MomentsEditor
{
	...
	public sealed class RecorderEditor : Editor
	{
        ...
        SerializedProperty m_PreprocessYield;
		...
		void OnEnable()
		{
            ...
            m_PreprocessYield = serializedObject.FindProperty("m_PreprocessYield");
		...
		public override void OnInspectorGUI()
		{
            ...
            EditorGUILayout.PropertyField(m_PreprocessYield, new GUIContent("Preprocess Yield", "Pauses between main thread texture preprocessing to lessen the load."));
